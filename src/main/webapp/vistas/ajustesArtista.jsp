...
<body>
<form:form class="form-horizontal" action="ajustesArtista" method="post" modelAttribute="artista">
    <fieldset>

        <!-- Form Name -->
        <legend>Ajustes Artista</legend>
        <form:hidden path="idArtista" value="${artista.getIdArtista()}"/>
        <form:hidden path="usuario" value="${artista.usuario}"/>
        <form:hidden path="password" value="${artista.password}"/>
