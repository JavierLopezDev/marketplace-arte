...
<head>
    ...
    <title>Perfil de Comprador</title>
    <style>
        /* Estilos generales */
        body {
...
<div class="profile-container">
    <div style="display: flex; align-items: center; justify-content: space-between; flex-direction: row">
        <div style="display: flex; align-items: center; flex-direction: row">
            ...
            <h1 class="artist-name">${comprador.getNombreCompleto()}</h1>
        </div>
        <form action="ajustesComprador">
            <input type="hidden" name="idComprador" value="${comprador.getIdComprador()}">
            <button type="submit" class="settings-button">Ajustes</button>
        </form>
    </div>

    <div class="artwork" style="display: flex; align-items: center; justify-content: space-between; flex-direction: column">
        <h3 class="artwork-name">Saldo: ${comprador.getSaldo()}€</h3>
        <form action="obrasEnVenta" class="addObra">
            <input type="hidden" name="idComprador" value="${comprador.getIdComprador()}">
            <button type="submit" class="settings-button" >Comprar Obras</button>
        </form>
    </div>


    <div class="artwork" style="display: flex; align-items: center; justify-content: space-between; flex-direction: column">
        <h2 class="artwork-name">Inventario</h2>
        <div class="artwork">
            <c:forEach items="${comprador.getInventario()}" var="obra">
                <div class="obra">
